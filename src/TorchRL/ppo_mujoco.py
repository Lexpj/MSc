...
def main(cfg: DictConfig):  # noqa: F821
    ...
    from utils_mujoco import eval_model, make_ppo_models
...
if __name__ == "__main__":
    ...
    cfg = OmegaConf.load("config_mujoco.yaml")  
    ...
    cfg.loss.normalize_advantage = config['train']['normalize_advantage'] # Was constant, changed to variable
