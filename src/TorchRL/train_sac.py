...
def main(cfg: DictConfig):  # noqa: F821
    ...
    if cfg.logger.backend:
        logger = get_logger(
            ...
            logger_name=f"results/sac_{cfg.env.name}_{cfg.collector.total_frames}/{cfg.hps}/",
...
if __name__ == "__main__":
    ...
    cfg = OmegaConf.load("config_sac.yaml")  
    ...
    cfg.optim.target_update_polyak = 1-config['train']['tau'] # It expects the that tau is the weight for the normal network, not the target network. So, this has to be inversed
