...
call = f"python td3_continuous_action.py "
...
call += f"--fw={config['fw']}\
 ...
 --policy_noise={config['train']['target_policy_noise']}\
 --policy_frequency={config['train']['policy_delay']}\
 --noise_clip={config['train']['target_noise_clip']}\
